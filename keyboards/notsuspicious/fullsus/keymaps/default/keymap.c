...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ansi(
		...
		_______, RM_NEXT, RM_VALU, RM_SPDU, _______, _______, _______, _______, _______, _______, _______, _______,          _______,                            _______, _______, _______,
		RM_TOGG, RM_PREV, RM_VALD, RM_SPDD, _______, _______, _______, _______, _______, _______, _______,                   _______,          _______,          _______, _______, _______, _______,
